...
<body>
    ...
    <div class="plant-list">
        ...
        <h1 class="my-4"><?= $plant['title']; ?></h1>
        
        <!-- Portfolio Item Row -->
        <div class="row">

            <div class="col-md-6">
            <p><i><b>Scientific Name:</b> <?= $plant['scien']; ?></i>
            <br><b>Common Names:</b> <?= $plant['comms']; ?></p>

                <img class=".img-fluid. max-width: 100% height: auto;" src=<?= $plant['image']; ?> alt=""  height="auto">
            </div>

            <div class="col-md-6">
                    <?php 
                        if (array_key_exists('desc', $plant))
                            echo "<p><b><strong> Description:</strong> " . $plant['desc'] . "</b></p>";
                        if (array_key_exists('imp', $plant))
                            echo "<p><b><strong> Importance:</strong> " . $plant['imp'] . "</b></p>";
                        if (array_key_exists('type', $plant))
                            echo "<p><b><strong> Type:</strong> " . $plant['type'] . "</b></p>";
                        if (array_key_exists('misc', $plant))
                            echo "<p><b>" . $plant['misc'] . "</b></p>";
                        if (array_key_exists('planted', $plant))
                            echo "<p><b><strong> Planted by:</strong> " . $plant['planted'] . "</b></p>";
                        if (array_key_exists('dist', $plant))
                            echo "<p><b><strong> Distribution:</strong> " . $plant['dist'] . "</b></p>";
                        if (array_key_exists('fam', $plant))
                            echo "<p><b><strong> Family:</strong> " . $plant['fam'] . "</b></p>";
                        if (array_key_exists('part', $plant))
                            echo "<p><b><strong> Parts used:</strong> " . $plant['part'] . "</b></p>";
                        if (array_key_exists('uses', $plant))
                            echo "<p><b><strong> Uses:</strong> " . $plant['uses'] . "</b></p>";
                        if (array_key_exists('loc', $plant))
                            echo "<p><b><strong> Location:</strong> " . $plant['loc'] . "</b></p>";
                            ?>
            </div>
